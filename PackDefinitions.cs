...
namespace ClassicMoonsHQModule
{
    internal class PackDefinition
    {
        ...
        {
            {OPI.BLURANCEFIX_GUID, "1.0.0" },
            {OPI.LERTZFIX_GUID, "1.0.0" },
            {OPI.TANDRAUSFIX_GUID, "1.1.0" }
        };
        ...
        internal static Dictionary<string, string> v56Mods = new Dictionary<string, string>
        {
            ...
            {OPI.DERELICT_MOON_PLUGIN_GUID, "1.0.0" }
        };
        ...
        internal static Dictionary<string, string> v62Mods = new Dictionary<string, string>
        {
            ...
            {OPI.DERELICT_MOON_PLUGIN_GUID, "1.2.0" }
        };
        ...
        internal static Dictionary<string, string> v81Mods = new Dictionary<string, string>
        {
            ...
            {OPI.PATHFINDINGLIB_GUID, "2.4.1" },
            {OPI.STARLANCERAIFIX_GUID, "3.13.2" },
            {OPI.LETHALLIB_GUID, "1.2.0" },
            {OPI.CULLFACTORY_GUID, "2.0.11" },
            {OPI.DERELICT_MOON_PLUGIN_GUID, "1.2.1" }
        };
    }
}
